					...
					{#if creatingFolder}
						<div class="flex items-center gap-2 px-3 py-1.5">
							...
							<input
								...
								class="flex-1 text-xs bg-transparent border border-gray-200 dark:border-gray-700 rounded px-1.5 py-0.5 outline-none focus:border-brand-400 dark:focus:border-brand-500"
