		...
		<div class="px-5 pb-4">
			...
			>
				...
				<div class="flex justify-end gap-2 pt-3 bg-gray-50 dark:bg-gray-900/50">
					<button
						class="px-3.5 py-1.5 text-sm font-medium bg-brand-500 hover:bg-brand-600 text-white dark:bg-brand-500 dark:text-white dark:hover:bg-brand-600 transition rounded-full"
						type="submit"
					>
						{$i18n.t('Add')}
					</button>
