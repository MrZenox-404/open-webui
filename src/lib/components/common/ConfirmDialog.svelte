						...
						{#if input}
							...
							{:else}
								<textarea
									...
									class="w-full mt-2 rounded-lg px-4 py-2 text-sm dark:text-gray-300 dark:bg-gray-900 outline-hidden resize-none border border-gray-300 dark:border-gray-700"
									rows="3"
									required
								/>
							{/if}
