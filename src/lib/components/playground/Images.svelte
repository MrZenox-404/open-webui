						...
						<div class="flex gap-2 shrink-0">
							{#if !loading}
								<button
									...
									class="px-3.5 py-1.5 text-sm font-medium bg-brand-500 hover:bg-brand-600 text-white dark:bg-brand-500 dark:hover:bg-brand-600 dark:text-white transition rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
