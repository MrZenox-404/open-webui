	...
	<div class="px-5 pt-4 pb-5">
		...
		<form on:submit|preventDefault={submitHandler}>
			...
			<div class="mt-4 flex items-center justify-between">
				...
				<div>
					<button
						class="text-sm px-4 py-2 transition rounded-none {loading
		...
		<div class="flex items-start justify-between gap-4 shrink-0">
			...
			<div>
				<div class="flex items-center gap-2 shrink-0 justify-end">
					{#if !disabled}
						<button
							class="px-4 py-1 text-sm font-medium bg-brand-500 text-white dark:bg-brand-500 dark:text-white rounded-none hover:opacity-90 transition shadow-xs"
						...
						<button
							class="bg-gray-50 hover:bg-gray-100 text-black dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-white transition px-2.5 py-1 rounded-none flex gap-1.5 items-center text-sm border border-gray-100 dark:border-gray-800"
					...
					{:else}
						<span class="text-xs text-gray-500 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-none"
